...
/*!40000 ALTER TABLE tb_sys_log DISABLE KEYS */;
/*!40000 ALTER TABLE tb_sys_log ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE tb_sys_role_route DISABLE KEYS */;
/*!40000 ALTER TABLE tb_sys_role_route ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sys_route` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='路由表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE tb_sys_route DISABLE KEYS */;
INSERT INTO tb_sys_route (`id`, `url`, `name`, `parent_id`, `weight`) VALUES (1,'sys/role/update','',NULL,NULL),(2,'sys/role/delete{id}','',NULL,NULL),(3,'sys/role/get','',NULL,NULL),(4,'sys/role/list','',NULL,NULL),(5,'sys/role/data','',NULL,NULL),(6,'sys/role/delete','',NULL,NULL),(7,'sys/role/delete','',NULL,NULL),(8,'sys/role/save','',NULL,NULL),(9,'sys/user/update','',NULL,NULL),(10,'sys/user/delete{id}','',NULL,NULL),(11,'sys/user/get','',NULL,NULL),(12,'sys/user/list','',NULL,NULL),(13,'sys/user/data','',NULL,NULL),(14,'sys/user/delete','',NULL,NULL),(15,'sys/user/delete','',NULL,NULL),(16,'sys/user/save','',NULL,NULL),(17,'customer/info/update','',NULL,NULL),(18,'customer/info/list','',NULL,NULL),(19,'customer/info/data','',NULL,NULL),(20,'customer/info/save','',NULL,NULL),(21,'customer/info/delete','',NULL,NULL),(22,'customer/info/delete{id}','',NULL,NULL),(23,'customer/info/delete','',NULL,NULL),(24,'customer/log/list','',NULL,NULL),(25,'customer/log/data','',NULL,NULL),(26,'sys/serviceRoute/list','',NULL,NULL);
/*!40000 ALTER TABLE tb_sys_route ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tb_customer_info` (
  ...
  KEY `phone` (`phone`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='tb_customer_info';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `tb_customer_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_customer_log` ENABLE KEYS */;
UNLOCK TABLES;
