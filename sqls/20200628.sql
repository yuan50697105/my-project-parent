...
INSERT INTO tb_sys_route (`id`, `url`) VALUES (1,'sys/role/update'),(2,'sys/role/delete{id}'),(3,'sys/role/get'),(4,'sys/role/list'),(5,'sys/role/data'),(6,'sys/role/delete'),(7,'sys/role/delete'),(8,'sys/role/save'),(9,'sys/user/update'),(10,'sys/user/delete{id}'),(11,'sys/user/get'),(12,'sys/user/list'),(13,'sys/user/data'),(14,'sys/user/delete'),(15,'sys/user/delete'),(16,'sys/user/save');
