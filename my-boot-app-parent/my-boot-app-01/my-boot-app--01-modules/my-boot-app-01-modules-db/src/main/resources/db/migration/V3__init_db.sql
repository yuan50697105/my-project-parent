create table if not exists my_project.area_address
(
...
create table if not exists my_project.area_info
(
    id   bigint(15) auto_increment comment 'id'
        primary key,
...
create table if not exists my_project.auth_permission
(
    id          bigint(15) auto_increment comment 'id'
        primary key,
    name        varchar(50) default '' not null comment 'name',
...
create table if not exists my_project.auth_role
(
    id          bigint(15) auto_increment comment 'id'
        primary key,
    name        varchar(50) default '' not null comment 'name',
...
create table if not exists my_project.auth_user
(
    id              bigint(15) auto_increment comment 'id'
        primary key,
...
create table if not exists my_project.customer_info
(
    id        bigint(15) auto_increment comment 'id'
        primary key,
    code      varchar(50) default '' not null comment 'code',
...
create table if not exists my_project.customer_type
(
    id          bigint(15) auto_increment comment 'id'
        primary key,
    name        varchar(50) default '' not null comment 'name',
...
create table if not exists my_project.device_info
(
    id      bigint(15) auto_increment comment 'id'
        primary key,
    code    varchar(50) default '' not null comment 'code',
...
create table if not exists my_project.price_info
(
    id       bigint(15) auto_increment comment 'id'
        primary key,
    code     varchar(50)    default ''      not null comment 'code',
...
alter table my_project.device_info
    add start_time datetime null comment '启用时间';

alter table my_project.device_info
    add end_time datetime null comment '停用时间';
