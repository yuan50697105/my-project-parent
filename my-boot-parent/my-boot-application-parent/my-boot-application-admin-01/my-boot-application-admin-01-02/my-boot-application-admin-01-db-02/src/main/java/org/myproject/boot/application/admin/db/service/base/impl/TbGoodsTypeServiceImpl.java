...
public class TbGoodsTypeServiceImpl implements TbGoodsTypeService {
    ...
    @Override
    public PageInfo<TbGoodsType> selectByExample(TbGoodsTypeExample example, int page, int pageSize) {
        PageHelper.startPage(page, pageSize);
        return new PageInfo<>(tbGoodsTypeMapper.selectByExample(example));
    }
    ...
    @Override
    public PageInfo<TbGoodsType> selectByQuery(TbGoodsTypeQuery query, int page, int pageSize) {
