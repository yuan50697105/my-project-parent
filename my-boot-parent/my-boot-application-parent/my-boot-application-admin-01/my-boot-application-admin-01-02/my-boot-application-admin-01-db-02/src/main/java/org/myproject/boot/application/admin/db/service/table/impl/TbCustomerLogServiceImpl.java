...
public class TbCustomerLogServiceImpl implements TbCustomerLogService {
    ...
    @Override
    public PageInfo<TbCustomerLog> selectByQuery(TbCustomerLogQuery query, int page, int size) {
        PageHelper.startPage(page, size);
        return new PageInfo<>(tbCustomerLogMapper.selectByExample(query.toExample()));
    }

    @Override
    public PageInfo<TbCustomerLog> selectByExample(TbCustomerLogExample example, int page, int pageSize) {
