...
public interface TbGoodsTypeService {
    ...
    PageInfo<TbGoodsType> selectByExample(TbGoodsTypeExample example, int page, int pageSize);

    PageInfo<TbGoodsType> selectByQuery(TbGoodsTypeQuery query, int page, int pageSize);
