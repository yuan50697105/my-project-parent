...
import org.apache.ibatis.annotations.Param;import org.myproject.boot.application.admin.db.pojo.TbGoodsInfo;import org.myproject.boot.application.admin.db.pojo.TbGoodsInfoExample;import java.util.List;

@Mapper
public interface TbGoodsInfoMapper extends tk.mybatis.mapper.common.Mapper<TbGoodsInfo> {
