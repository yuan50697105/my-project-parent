...
public class BSysUserServiceImpl implements BSysUserService {
    ...
    public IPage<SysUser> selectByQuery(SysUserQuery query, int page, int size) {
        org.myproject.boot.application.admin.db.pojo.SysUserQuery sysUserQuery = sysUserConverter.convert(query);
        PageInfo<org.myproject.boot.application.admin.db.pojo.SysUser> pageInfo = sysUserService.selectByQuery(sysUserQuery, page, size);
    ...
    public List<SysUser> selectByQuery(SysUserQuery query) {
        ...
        org.myproject.boot.application.admin.db.pojo.SysUserQuery sysUserQuery = sysUserConverter.convert(query);
        List<org.myproject.boot.application.admin.db.pojo.SysUser> list = sysUserService.selectByQuery(sysUserQuery);
        return sysUserConverter.convert(list);
    }

    @Override
    public SysUser selectByPrimaryKey(Long id) {
        org.myproject.boot.application.admin.db.pojo.SysUser sysUser = sysUserService.selectByPrimaryKey(id);
        return sysUserConverter.convert(sysUser);
    }

    @Override
    public int insert(SysUserVo sysUserVo) {
        org.myproject.boot.application.admin.db.pojo.SysUser sysUser = sysUserConverter.convert(sysUserVo);
